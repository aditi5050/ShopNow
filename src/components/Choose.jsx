    ...
    <div className="choose-us-container mx-3 py-3">
      <div className="container">
        <div className="title-container">
          <h2>Why shold you choose us?</h2>
          <p>
          We provide the best quality products at the best price possible we take care of your customers like family so they always choose us over anyone else :)
          </p>
        </div>
